...
return [
    ...
    'fields' => [
        ...
        'icon' => [
            ...
            'helper' => 'Любое имя иконки, поддерживаемое Filament, например Heroicon. Полный список — на :link.',
        ],
        'favicon_url' => [
            'label' => 'URL фавикона',
        ],
    ...
    'import' => [
        'description' => 'Загрузите JSON-файл, ранее экспортированный из этого меню. Пункты будут добавлены к существующим, если не включена замена.',
        'file' => 'Файл экспорта (JSON)',
        'replace' => 'Заменить текущее меню',
        'replace_helper' => 'Все существующие пункты меню будут удалены перед импортом.',
    ],
    ...
    'notifications' => [
        ...
        'import_success' => 'Импортировано пунктов меню: :count',
        'import_invalid' => 'Файл не является корректным экспортом меню',
    ],
